...
#	words = ['shoes']
	...
	print clust.max()
	struct_cons(model,x,y,z,max_len,n_terms,s,syllseq,pos,t2n,tagseq,clust)#set structural constraints
...
def struct_cons(model,x,y,z,max_len,n_terms,s,syllseq,pos,t2n,tagseq,clust):
	n_terms, n_clusts = clust.shape
