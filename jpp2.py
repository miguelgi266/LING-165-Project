...
def open_proc(flnm):
	...
	sents = [[tok for tok in sent if tok not in ['``','"'] and tok not in string.punctuation] for sent in sents] #block for original
	origsents = sents[:]
